...
public class CreepyWareGui extends GuiScreen
{
    ...
    public static CreepyWareGui getInstance() {
        if (kurohack.features.gui.CreepyWareGui.INSTANCE == null) {
            kurohack.features.gui.CreepyWareGui.INSTANCE = new CreepyWareGui();
        }
        return kurohack.features.gui.CreepyWareGui.INSTANCE;
    }
    
    public static CreepyWareGui getClickGui() {
        final CreepyWareGui creepyWareGui = kurohack.features.gui.CreepyWareGui.CreepyWareGui;
        return getInstance();
    }
    
    private void setInstance() {
        kurohack.features.gui.CreepyWareGui.INSTANCE = this;
    }
    ...
    private void load() {
        ...
        for (final Module.Category category : KuroHack.moduleManager.getCategories()) {
            ...
            x += 100;
            components2.add(new Component(name, x, 8, true) {
    ...
    public void drawImageLogo() {
        ...
        drawCompleteImage(0, 400, 250, 55);
        this.mc.getTextureManager().bindTexture(logo);
