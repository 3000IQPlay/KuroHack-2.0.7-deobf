...
public class Component extends Feature
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        KuroHack.textManager.drawStringWithShadow(this.getName(), this.x + 3.0f, this.y - 4.0f - CreepyWareGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
            Component.mc.getTextureManager().bindTexture(this.arrow);
            ModuleButton.drawCompleteImage(this.x - 1.5f + this.width - 12.0f, this.y - 5.0f - CreepyWareGui.getClickGui().getTextOffset(), 12, 11);
