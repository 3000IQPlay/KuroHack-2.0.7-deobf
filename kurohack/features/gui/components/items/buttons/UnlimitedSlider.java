...
public class UnlimitedSlider extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        KuroHack.textManager.drawStringWithShadow(" - " + this.setting.getName() + " §7" + this.setting.getValue() + "§r +", this.x + 2.3f, this.y - 1.7f - CreepyWareGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
