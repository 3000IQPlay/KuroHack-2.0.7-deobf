...
public class Slider extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        KuroHack.textManager.drawStringWithShadow(this.getName() + " §7" + ((this.setting.getValue() instanceof Float) ? this.setting.getValue() : Double.valueOf(this.setting.getValue().doubleValue())), this.x + 2.3f, this.y - 1.7f - CreepyWareGui.getClickGui().getTextOffset(), -1);
    }
