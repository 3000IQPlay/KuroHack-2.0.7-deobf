...
public class NoRender extends Module
{
    ...
    public NoRender() {
        ...
        this.skylight = (Setting<Skylight>)this.register(new Setting("Speed", "Skylight", 0.0, 0.0, (T)Skylight.NONE, 0));
        ...
        this.advancements = (Setting<Boolean>)this.register(new Setting("Speed", "Advancements", 0.0, 0.0, (T)false, 0));
        this.pigmen = (Setting<Boolean>)this.register(new Setting("Speed", "Pigmen", 0.0, 0.0, (T)false, 0));
        this.timeChange = (Setting<Boolean>)this.register(new Setting("Speed", "TimeChange", 0.0, 0.0, (T)false, 0));
