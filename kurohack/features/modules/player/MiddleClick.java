            ...
            if (result != null && result.typeOfHit == RayTraceResult.Type.ENTITY && (entity = result.entityHit) instanceof EntityPlayer) {
                if (KuroHack.friendManager.isFriend(entity.getName())) {
                    ...
                    if (FriendSettings.getInstance().notify.getValue()) {
                        Util.mc.player.connection.sendPacket((Packet)new CPacketChatMessage("/w " + entity.getName() + " I just removed you from my friends list on CreepyWare!"));
                    }
                    ...
                    if (FriendSettings.getInstance().notify.getValue()) {
                        Util.mc.player.connection.sendPacket((Packet)new CPacketChatMessage("/w " + entity.getName() + " I just added you to my friends list on CreepyWare!"));
                    }
