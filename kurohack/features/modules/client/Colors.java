...
public class Colors extends Module
{
    ...
    public Colors() {
        ...
        this.green = (Setting<Integer>)this.register(new Setting("Green", (T)20, (T)0, (T)255, v -> !this.rainbow.getValue()));
    ...
    public void onTick() {
        ...
        if (ClickGui.getInstance().colorSync.getValue()) {
            KuroHack.colorManager.setColor(Colors.INSTANCE.getCurrentColor().getRed(), Colors.INSTANCE.getCurrentColor().getGreen(), Colors.INSTANCE.getCurrentColor().getBlue(), ClickGui.getInstance().hoverAlpha.getValue());
        }
    }
