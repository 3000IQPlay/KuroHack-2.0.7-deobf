...
public class AntiTrap extends Module
{
    ...
    private void placeCrystal(final BlockPos pos) {
        ...
        final float[] angle = MathUtil.calcAngle(AntiTrap.mc.player.getPositionEyes(Util.mc.getRenderPartialTicks()), new Vec3d((double)(pos.getX() + 0.5f), (double)(pos.getY() - 0.5f), (double)(pos.getZ() + 0.5f)));
